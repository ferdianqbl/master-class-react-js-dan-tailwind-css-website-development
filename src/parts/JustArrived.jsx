  ...
  return (
    <section className="flex flex-col py-16">
      <div className="container mx-auto mb-4">
        <h3 className="text-2xl capitalize font-semibold mb-5 text-center">
        ...
        <div className="flex -mx-4 flex-row relative">
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/images/image-arrived-1.png"
                alt=""
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/images/image-arrived-2.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/images/image-arrived-3.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/images/image-arrived-4.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div className="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/images/image-arrived-5.png"
                alt=""
                className="w-full h-full object-cover object-center"
              />
            </div>
