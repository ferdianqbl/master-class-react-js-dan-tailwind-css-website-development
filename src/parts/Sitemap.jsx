  ...
  return (
    <section className="sitemap">
      <div className="border-t border-b border-gray-200 py-12 mt-16 px-4">
        <p className="text-3xl text-center font-bold text-purple-700 mb-6">
          Space<span className="text-blue-700">Ture</span>
        </p>
        <aside className="container mx-auto">
          <div className="flex flex-wrap md:space-x-10 justify-center">
